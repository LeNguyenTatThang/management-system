...
export const mockOrders = [
  {
    id: 'DH001',
    time: '10:24 22/07/2026',
    items: [
      {
        id: 'oi_mock1',
        productId: 'CF002',
        name: 'Bạc xỉu',
        image: 'https://coffee.alexflipnote.dev/random?2',
        category: 'Cà phê',
        size: 'medium',
        sizeLabel: 'M',
        sweetness: 50,
      ...
      },
      {
        ...
        promotionLabel: 'HAPPY HOUR',
        finalPrice: 25000,
      },
    ],
    subtotal: 85000,
    totalPromotionDiscount: 5000,
    ...
    staff: 'Nguyễn Văn A',
    status: 'Hoàn thành',
    promotionApplied: [{ id: 'KM01', name: 'HAPPY HOUR' }],
    appliedVouchers: [
      { id: 'VC01', code: 'SALE10', name: 'Giảm 10K', type: 'fixed', value: 10000, minOrder: 0, maxDiscount: null },
    ],
    orderBespoke: [
      {
        id: 'BSP001',
  ...
  {
    id: 'DH002',
    time: '10:30 22/07/2026',
    items: [
      {
        id: 'oi_mock3',
        productId: 'TS001',
        name: 'Trà sữa trân châu',
        image: 'https://coffee.alexflipnote.dev/random?4',
        category: 'Trà sữa',
        size: 'small',
        sizeLabel: 'S',
        sweetness: 100,
  ...
  },
  {
    ...
    promotionApplied: [],
    appliedVouchers: [
      { id: 'VC03', code: 'WELCOME', name: 'Chào mừng', type: 'fixed', value: 15000, minOrder: 0, maxDiscount: null },
    ],
    orderBespoke: [],
  },
];
