    ...
    <PageContainer>
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-2 text-sm text-muted mb-1">
          <button className="hover-text-primary cursor-pointer" onClick={() => navigate('/recipes')}>Công thức thành phần nguyên liệu</button>
          <span>&gt;</span>
        ...
        <h1 className="text-2xl font-bold mb-6">Thêm công thức thành phần nguyên liệu</h1>
        ...
        <div className="card mb-6">
          ...
          <div className="flex flex-col gap-4">
            <div>
              <label className="block text-sm font-semibold mb-1">Tên thành phần <span className="text-danger">*</span></label>
