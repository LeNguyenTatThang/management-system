        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-overlay p-4">
          <div className="card animate-fade-slide-in w-full max-w-500px">
            ...
            <div className="flex flex-col gap-4">
              ...
              <FormTextarea placeholder="Mô tả nhà cung cấp..." value={form.description} onChange={handleChange('description')} rows={3} />
              <FormTextarea placeholder="Nhập ghi chú..." value={form.notes} onChange={handleChange('notes')} rows={3} />
