  ...
  return (
    <div className="sidebar hidden md:flex flex-col">
      <div className="sidebar-header">
        <div style={{ width: 32, height: 32, borderRadius: '50%', backgroundColor: 'var(--primary)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>D</div>
        <div>
      ...
      <div style={{ padding: 'var(--spacing-4)', borderTop: '1px solid var(--border-color)' }}>
        ...
        <div className="nav-item text-danger"><LogOut size={18} /> Logout</div>
      </div>
    </div>
  );
}
